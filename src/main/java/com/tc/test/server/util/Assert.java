...
public class Assert {
   ...
   * </code> or whatever. If this just
   * threw the exception itself, the compiler would complain (above) that there's no value being returned.
   * 
   * @param message The message to put in the assertion error
   * @return New AssertionError, ready to throw
   */
  public static AssertionError failure(Object message) {
  ...
  public static void eval(Object message, boolean expr) {
    if ((!expr) && isEnabled()) { throw failure("Assertion failed: " + message); }
    return;
  }
  ...
  public static void assertNull(Object what, Object o) {
    if ((o != null) && isEnabled()) { throw failure(what + " was not null"); }
  }
  ...
  public static void assertNotNull(Object what, Object o) {
    if ((o == null) && isEnabled()) { throw new NullPointerException(what + " is null"); }
  }
  ...
  public static void assertNotEmpty(Object what, String s) {
    ...
    if ((s.length() == 0) && isEnabled()) throw new IllegalArgumentException(what + " is empty");
  }
  ...
  public static void assertNotBlank(Object what, String s) {
    ...
    if ((s.trim().length() == 0) && isEnabled()) throw new IllegalArgumentException(what + " is blank");
  }
  ...
  public static void assertEquals(int expected, int actual) {
    if (expected != actual && isEnabled()) { throw new AssertionError("Expected <" + expected + "> but got <" + actual
                                                                      + ">"); }
  }
  ...
  public static void assertEquals(Object msg, int expected, int actual) {
    if (expected != actual && isEnabled()) { throw new AssertionError(msg + ": Expected <" + expected + "> but got <"
                                                                      + actual + ">"); }
  }
  ...
  public static void assertEquals(double expected, double actual, double epsilon) {
    if (Math.abs(actual - expected) > Math.abs(epsilon) && isEnabled()) { throw new AssertionError("Expected <"
                                                                                                   + expected
                                                                                                   + "> but got <"
                                                                                                   + actual + ">"); }
  }
  ...
  public static void assertEquals(byte[] expected, byte[] actual) {
    ...
    if (!expr && isEnabled()) { throw new AssertionError("Got differing byte[]s"); }
  }
  ...
  public static void assertEquals(Object msg, Object expected, Object actual) {
    ...
    if (!expr && isEnabled()) { throw new AssertionError((msg != null ? (msg + ": ") : "") + "Expected <" + expected
                                                         + "> but got <" + actual + ">"); }
  }
  ...
  public static void assertContainsElement(Object[] objectArray, Object requiredElement) {
    ...
    if (isEnabled()) { throw failure("Element<" + requiredElement + "> not found in array "
  ...
  public static void assertDoesNotContainsElement(Object[] objectArray, Object element) {
    ...
    for (int pos = 0; pos < objectArray.length; pos++) {
      if (objectArray[pos] == element) {
        failure("Element<" + element + "> was found in array " + Arrays.asList(objectArray));
      }
    }
  }
  ...
  public static void fail() {
    if (isEnabled()) { throw failure("generic failure"); }
  }
  ...
  public static void fail(String message) {
    if (isEnabled()) { throw failure(message); }
  }
  ...
  public static void pre(boolean v) {
    if (!v && isEnabled()) throw new AssertionError("Precondition failed");
  }
  ...
  public static void post(boolean v) {
    if (!v && isEnabled()) throw new AssertionError("Postcondition failed");
  }
  ...
  public static void inv(boolean v) {
    if (!v && isEnabled()) throw new AssertionError("Invariant failed");
  }
}