 ...
 */
public final class Jetty94xAppServerFactory extends AppServerFactory {
  ...
  public AppServer createAppServer(AppServerInstallation installation) {
    return new Jetty94xAppServer(installation);
  }

  @Override
  public AppServerInstallation createInstallation(File home, File workingDir, AppServerInfo appServerInfo)
      throws Exception {
    return new Jetty94xAppServerInstallation(home, workingDir, appServerInfo);
  }
}
