 ...
 */
public final class JBoss72xAppServerFactory extends AppServerFactory {
  ...
  public AppServer createAppServer(AppServerInstallation installation) {
    return new JBoss72xAppServer((JBoss72xAppServerInstallation) installation);
  }

  @Override
  public AppServerInstallation createInstallation(File home, File workingDir, AppServerInfo appServerInfo)
      throws Exception {
    return new JBoss72xAppServerInstallation(home, workingDir, appServerInfo);
  }
}
