 ...
 */
public final class Was8xAppServerFactory extends AppServerFactory {
  ...
  public AppServer createAppServer(AppServerInstallation installation) {
    return new Was8xAppServer(installation);
  }

  @Override
  public AppServerInstallation createInstallation(File home, File workingDir, AppServerInfo appServerInfo)
      throws Exception {
    return new Was8xAppServerInstallation(home, workingDir, appServerInfo);
  }
}
