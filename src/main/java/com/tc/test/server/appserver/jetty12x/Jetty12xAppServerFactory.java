 ...
 */
public final class Jetty12xAppServerFactory extends AppServerFactory {
  ...
  public AppServer createAppServer(AppServerInstallation installation) {
    return new Jetty12xAppServer(installation);
  }

  @Override
  public AppServerInstallation createInstallation(File home, File workingDir, AppServerInfo appServerInfo)
      throws Exception {
    return new Jetty12xAppServerInstallation(home, workingDir, appServerInfo);
  }
}
